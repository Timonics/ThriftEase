...
const Note = () => {
  return (
    <div className="flex flex-col h-[300px] gap-10 justify-center items-center bg-[#34495E] font-poppins">
      ...
      <Link className="p-2 rounded-xl w-[200px] hover:scale-125 transition ease-in-out duration-500 text-[#34495E] text-center bg-[#2ECC71] hover:bg-[#9bc8fff0] hover:text-slate-900 font-bold">Explore</Link>
    </div>
  );
};
