    ...
    <>
      <div className="p-4 bg-[#f0f4ef] shadow-slate-300 shadow-xl">
        ...
        <div className="flex flex-col justify-center items-center  h-[420px] gap-5">
          <h1 className="text-7xl font-extrabold text-[#2ECC71]">ThriftEase!</h1>
          ...
          <div className="space-x-5 text-lg flex w-[50%] text-center justify-center mt-5">
            <Link to="home" className="border-4 flex items-center justify-center border-[#2ECC71] p-2 rounded-xl w-[30%] text-[#2ECC71] font-bold">
              Start Shopping
            </Link>
            <Link className="p-2 flex items-center justify-center rounded-xl w-[30%] shadow-xl bg-[#2ECC71] text-[#34495E] font-bold">Sign Up</Link>
          </div>
        </div>
      </div>
      <WhatToExpect />
