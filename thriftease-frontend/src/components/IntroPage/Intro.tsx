...
import thriftBackground from "../../assets/thriftEaseBackground.webp";
    ...
    <>
      ...
      <div className="p-4 shadow-slate-400 h-screen shadow-xl">
        ...
        <div className="flex flex-col justify-center items-center h-[420px] gap-5">
          <h1 className="text-6xl font-bold text-white/75">
            Welcome to{" "}
            <span className="text-7xl text-appgreen font-extrabold">
              ThriftEase.
            </span>
          </h1>
          <p className="w-4/5 text-lg font-light text-center text-white/65">
