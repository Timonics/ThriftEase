...
import SubMiscellaneousCat from "./SubMiscellaneousCat";
...
const Miscellaneous = (props: Props) => {
  ...
  const oddsProductsElements = categoryProducts.map((product) => (
  ...
  return (
    <div className="flex flex-col gap-7">
      <SubMiscellaneousCat />
      <div className="flex p-4 gap-10">{oddsProductsElements}</div>
    </div>
  );
};
